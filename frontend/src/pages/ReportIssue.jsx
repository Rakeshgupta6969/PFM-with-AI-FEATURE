      ...
      <main className="flex-1 flex flex-col relative z-20 h-screen overflow-hidden">
        <header className="h-20 glass-card border-b border-white/5 flex items-center px-10 sticky top-0 z-30">
          <div className="flex items-center gap-3">
             ...
             <h1 className="text-xl font-bold text-white tracking-tight">Report an Issue</h1>
          </div>
        </header>
        ...
        <div className="flex-1 overflow-auto p-6 sm:p-10 hide-scrollbar">
          <div className="max-w-2xl mx-auto space-y-8 pb-20">
            <div className="text-center mb-10">
              <h2 className="text-3xl font-extrabold text-white mb-2">How can we help?</h2>
              <p className="text-gray-400">Describe the issue you're facing, and our team will get back to you shortly.</p>
            </div>
            ...
            {success ? (
              <div className="glass-card p-10 rounded-3xl border border-emerald-500/20 text-center animate-in fade-in zoom-in duration-500">
                ...
                <button 
                  ...
                  className="px-8 py-3 bg-white/5 hover:bg-white/10 text-white rounded-xl transition-all font-medium border border-white/10"
                >
                  Send another report
                </button>
              </div>
              ...
              <form onSubmit={handleSubmit} className="glass-card p-8 rounded-3xl border border-white/10 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-brand-500/50 transition-all"
                    />
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-gray-400 ml-1 flex items-center gap-2">
                    ...
                    <input
                      ...
                      className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-gray-400 cursor-not-allowed focus:outline-none transition-all"
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-brand-500/50 transition-all resize-none"
                  />
                </div>
