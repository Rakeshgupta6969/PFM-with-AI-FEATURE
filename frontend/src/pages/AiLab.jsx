      ...
      <main className="flex-1 flex flex-col relative z-20 h-screen overflow-hidden">
        <header className="h-20 glass-card border-b border-white/5 flex items-center px-10 sticky top-0 z-30">
          <div className="flex items-center gap-3">
             ...
             <h1 className="text-xl font-bold text-white tracking-tight">AI Financial Lab</h1>
          </div>
        </header>
        ...
        <div className="flex-1 overflow-auto p-6 sm:p-10 hide-scrollbar">
          <div className="max-w-4xl mx-auto space-y-10 pb-20">
            ...
            {/* Intro Hero Section */}
            <div className="relative p-10 rounded-3xl overflow-hidden glass-card border border-white/10 group">
            ...
            <div className="glass-card p-10 rounded-3xl border border-white/10 shadow-[0_4px_30px_rgba(0,0,0,0.5)]">
               <AiInsights />
            </div>
