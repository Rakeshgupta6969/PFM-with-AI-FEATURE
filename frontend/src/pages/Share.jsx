      ...
      <main className="flex-1 flex flex-col relative z-20 h-screen overflow-hidden">
        <header className="h-20 glass-card border-b border-[var(--border-primary)] flex items-center px-10 sticky top-0 z-30">
          <div className="flex items-center gap-3">
             ...
             <h1 className="text-xl font-bold text-[var(--text-primary)] tracking-tight">Share & Invite</h1>
          </div>
        </header>
          ...
          <div className="max-w-4xl mx-auto space-y-12 pb-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              <div className="space-y-6">
                ...
                <h2 className="text-5xl font-extrabold text-[var(--text-primary)] tracking-tight leading-tight">
                ...
                <div className="flex items-center gap-6 pt-4">
                  <div className="flex flex-col">
                    <span className="text-2xl font-bold text-[var(--text-primary)]">24/7</span>
                    <span className="text-xs text-[var(--text-secondary)] uppercase tracking-widest font-bold">Analytics</span>
                  </div>
                  <div className="w-px h-10 bg-[var(--border-primary)]"></div>
                  <div className="flex flex-col">
                    <span className="text-2xl font-bold text-[var(--text-primary)]">Global</span>
                    <span className="text-xs text-[var(--text-secondary)] uppercase tracking-widest font-bold">Coverage</span>
                  </div>
                  <div className="w-px h-10 bg-[var(--border-primary)]"></div>
                  <div className="flex flex-col">
                    <span className="text-2xl font-bold text-[var(--text-primary)]">Secure</span>
                    <span className="text-xs text-[var(--text-secondary)] uppercase tracking-widest font-bold">End-to-End</span>
                  </div>
                </div>
              </div>

              {/* Profile Preview Card */}
              <div className="glass-card p-1 rounded-[40px] border border-[var(--border-primary)] relative group">
                ...
                <div className="glass-card rounded-[36px] bg-[var(--bg-secondary)] p-8 border border-[var(--border-primary)] relative z-10 flex flex-col items-center text-center">
                  <div className="relative mb-6">
                     ...
                     <div className="w-24 h-24 rounded-full bg-[var(--bg-primary)] border-2 border-[var(--border-primary)] flex items-center justify-center text-4xl font-black text-[var(--text-primary)] relative z-10">
                       {user?.name?.charAt(0).toUpperCase()}
                     </div>
                     <div className="absolute -bottom-1 -right-1 bg-brand-500 p-2 rounded-full border-2 border-[var(--bg-primary)] z-20 shadow-xl">
                       <Award className="w-4 h-4 text-white" />
                     </div>
                  </div>
                  
                  <h3 className="text-2xl font-bold text-[var(--text-primary)] mb-2">{user?.name}</h3>
                  <div className="flex items-center gap-2 py-1 px-4 bg-[var(--border-primary)] border border-[var(--border-primary)] rounded-full mb-8">
                     <Zap className="w-3 h-3 text-brand-400" />
                     <span className="text-[10px] font-bold text-[var(--text-secondary)] uppercase tracking-widest">Premium Entity</span>
                  </div>

                  <div className="w-full bg-[var(--border-primary)] rounded-2xl p-4 border border-[var(--border-primary)] space-y-4">
                     <div className="flex justify-between items-center text-[11px] font-bold uppercase tracking-tighter text-[var(--text-secondary)]">
            ...
            {/* Direct Link Section */}
            <div className="glass-card p-8 rounded-3xl border border-[var(--border-primary)] space-y-6">
               ...
               <div className="flex flex-col sm:flex-row items-center gap-4">
                  <div className="flex-1 w-full bg-[var(--bg-primary)] border border-[var(--border-primary)] rounded-2xl p-4 flex items-center gap-4 group hover:border-brand-500/20 transition-all font-mono text-sm overflow-hidden">
                     <span className="text-[var(--text-secondary)] truncate flex-1">{shareUrl}</span>
                     <div className="hidden sm:block h-6 w-px bg-[var(--border-primary)]"></div>
                     <div className="text-[10px] text-[var(--text-secondary)] font-bold uppercase tracking-widest hidden sm:block">Unique ID</div>
                  </div>
                  <button 
                    onClick={handleCopy}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
               {socialPlatforms.map((platform) => (
                 ...
                 >
                   <div className="p-4 rounded-2xl mb-4 bg-[var(--border-primary)] border border-[var(--border-primary)] transition-all group-hover:scale-110 group-hover:bg-brand-500/10">
                      <platform.icon className={`w-8 h-8 ${platform.textColor} ${platform.name === 'WhatsApp' ? 'fill-emerald-400/10' : ''}`} />
                   </div>
                   <h4 className="text-xl font-bold text-[var(--text-primary)] mb-2">{platform.name}</h4>
                   <p className="text-xs text-[var(--text-secondary)] font-medium tracking-wide uppercase">{platform.description}</p>
                   
                   <div className="mt-6 p-2 bg-[var(--border-primary)] rounded-full opacity-0 group-hover:opacity-100 transition-opacity">
            ...
            {/* Success Info */}
            <div className="text-center p-12 glass-card rounded-[40px] border border-[var(--border-primary)] relative overflow-hidden group">
               ...
               <p className="text-[var(--text-secondary)] font-medium italic relative z-10 max-w-xl mx-auto">
